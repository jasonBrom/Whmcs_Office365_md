...
<form method="post" action="clientarea.php?action=productdetails">
            ...
            <input type="hidden" name="stsate" value="1" />
            邮箱前缀：<input type="text" name="usemail">@{$domains}
...
<div class="alert alert-success">
  <strong>账户开通成功!</strong> 用户名/Email:{$tipss}
</div>
{elseif $tipscode eq '2'}
<div class="alert alert-danger">
  <strong>错误!</strong> {$tipss}
</div>
{/if}
